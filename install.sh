...
if [ ! -d $ROOT/models/ssd_inception_v2_coco_2017_11_17 ]; then
	echo -e '\n\n--- Get the COCO model ---'
	wget http://download.tensorflow.org/models/object_detection/ssd_inception_v2_coco_2017_11_17.tar.gz -O $ROOT/models/ssd_inception_v2_coco_2017_11_17.tar.gz
	tar xf $ROOT/models/ssd_inception_v2_coco_2017_11_17.tar.gz -C $ROOT/models
fi